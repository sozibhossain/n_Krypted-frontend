...
export function BookingModal({ isOpen, onClose, dealId }: BookingModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md p-0 bg-black text-white overflow-hidden border-transparent">
        ...
        <div className="p-6 space-y-6">
          {isLoading ? (
            ...
            <>
              ...
              <Button className="w-full bg-white text-black hover:bg-gray-200 font-semibold mt-4">
                Pay now
              </Button>
            </>
          ) : (
